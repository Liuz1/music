...
def get_ali_object():
    ...
    app_id = "2016092500595726"  #  APPID （沙箱应用）
    ...
    # 支付完成后，跳转的地址。
    return_url = "http://127.0.0.1:8000/vip"
    ...
    alipay = AliPay(
        ...
        alipay_public_key_path=alipay_public_key_path,  # 支付宝的公钥，验证支付宝回传消息使用，不p是你自己的公钥
        debug=True,  # 默认False,
    )
    return alipay
...
def page1(request):
    ...
    pay_url = "https://openapi.alipaydev.com/gateway.do?{}".format(query_params)  # 支付宝网关地址（沙箱应用）
